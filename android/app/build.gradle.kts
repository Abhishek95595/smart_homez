...
android {
    namespace = "com.smartbuildingmanager.flutter_app"
    ...
    defaultConfig {
        ...
        applicationId = "com.smartbuildingmanager.flutter_app"
    ...
    signingConfigs {
        create("hasomiDebug") {
            ...
            if (keyAliasVal != null && keyPasswordVal != null && storeFileVal != null && storePasswordVal != null) {
                ...
                // Fallback to default debug configuration so compilation does not crash
