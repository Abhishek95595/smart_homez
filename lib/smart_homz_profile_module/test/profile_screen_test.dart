...
void main() {
  ...
  group('1. ProfileThemeData & Theme Resolution Tests', () {
    test('verifies Light theme palette constants', () {
      ...
      expect(light.background, equals(AppColors.background));
      expect(light.panel, equals(AppColors.surface));
      expect(light.accent, equals(AppColors.primary));
      expect(light.textPrimary, equals(AppColors.textPrimary));
      expect(light.textSecondary, equals(AppColors.textSecondary));
    });

    testWidgets('resolves light theme for Profile screen', (tester) async {
      ...
      expect(resolved.background, equals(AppColors.background));
    });
  });
