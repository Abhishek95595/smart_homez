...
class MockData {
        ...
        Building(
          ...
          towers: [
            Tower(
              id: 'palm_tower_1',
              name: 'Palm Tower 1',
              commonAreas: ['Pool Side', 'Gym', 'Clubhouse'],
              flats: [
                Flat(id: 'flat_501', label: '501', floor: 1),
                Flat(id: 'flat_601', label: '601', floor: 2),
              ],
            ),
          ],
        ),
  ...
  static List<Device> demoDevices() {
    ...
    return [
      ...
      Device(
        deviceId: 'dev_light_501',
        type: DeviceType.light,
        name: 'Living Room Light',
        firmwareVersion: '1.5.0',
        macAddress: 'CC:DD:01:01:01:01',
        tenantId: tenantId,
        buildingId: 'bldg_B',
        towerId: 'palm_tower_1',
        flatId: 'flat_501',
        floorId: 'palm_floor_1',
        roomId: 'room_501_living',
        zone: 'Living Room',
        isOn: true,
        lastHeartbeat: now,
      ),
      Device(
        deviceId: 'dev_fan_501',
        type: DeviceType.fan,
        name: 'Living Room Fan',
        firmwareVersion: '1.5.0',
        macAddress: 'CC:DD:01:01:01:02',
        tenantId: tenantId,
        buildingId: 'bldg_B',
        towerId: 'palm_tower_1',
        flatId: 'flat_501',
      ...
      Device(
        ...
        macAddress: 'CC:DD:01:02:01:01',
        tenantId: tenantId,
        buildingId: 'bldg_B',
        towerId: 'palm_tower_1',
        flatId: 'flat_601',
        floorId: 'palm_floor_2',
        roomId: 'room_601_bedroom',
        zone: 'Bedroom',
        isOn: true,
        dimLevel: 22,
        lastHeartbeat: now,
