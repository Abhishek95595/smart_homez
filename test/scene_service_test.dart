...
void main() {
  ...
  group('SceneService - 7 Scenes API Endpoints OpenAPI Compliance', () {
    // 1. GET /api/v1/scenes
    test('1. GET /api/v1/scenes: List all scenes for authenticated client', () async {
    ...
    test('2. POST /api/v1/scenes: Create a new scene with device actions', () async {
    ...
    test('4. PUT /api/v1/scenes/{id}: Update a scene name or device actions', () async {
      when(mockApi.put('/api/v1/scenes/scene_123', data: anyNamed('data'))).thenAnswer(
        (_) async => Response(
          requestOptions: RequestOptions(path: '/api/v1/scenes/scene_123'),
          statusCode: 200,
          data: {
    ...
    test('5. DELETE /api/v1/scenes/{id}: Permanently delete a scene (204 Deleted)', () async {
    ...
    test('6. POST /api/v1/scenes/{id}/activate: Activate a scene immediately', () async {
      when(mockApi.post('/api/v1/scenes/scene_123/activate')).thenAnswer(
        (_) async => Response(
          requestOptions: RequestOptions(path: '/api/v1/scenes/scene_123/activate'),
          statusCode: 200,
    ...
    test('7. GET /api/v1/scenes/{id}/status: Phase 3 sequential scene execution progress & deterministic idle shape', () async {
      // Active execution status
      when(mockApi.get('/api/v1/scenes/scene_123/status')).thenAnswer(
        (_) async => Response(
          requestOptions: RequestOptions(path: '/api/v1/scenes/scene_123/status'),
          statusCode: 200,
          data: {
            'success': true,
            'data': {
      ...
      when(mockApi.get('/api/v1/scenes/idle_scene/status')).thenAnswer(
        (_) async => Response(
          requestOptions: RequestOptions(path: '/api/v1/scenes/idle_scene/status'),
          statusCode: 200,
          data: {
            'success': true,
            'data': {
